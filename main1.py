...
def main():
    ...
    while True:
        ...
        # findLaneLines.PID_controll(processed_frame)
        # 처리된 이미지 표시
    ...
    # findLaneLines.process_video("project_video.mp4","output3.mp4")
    # findLaneLines.process_image("/home/erp-42/catkin_ws/src/Advanced-Lane-Lines/test_images/test6.jpg", "/home/erp-42/test.jpg")
